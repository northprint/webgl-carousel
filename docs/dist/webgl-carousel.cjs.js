...
const WebGLCarouselReact = React.forwardRef((props, ref) => {
...
const WebGLCarouselVue = vue.defineComponent({
    ...
    setup(props, { expose }) {
        ...
        vue.watch(() => props.images, (newImages) => {
            if (carousel) {
                carousel.updateImages(newImages);
            }
        });
        vue.watch(() => props.autoplay, (newAutoplay) => {
            if (carousel) {
                if (newAutoplay) {
                    carousel.play();
                }
        ...
        vue.watch(() => props.interval, (newInterval) => {
            if (carousel) {
                carousel.setAutoplay(props.autoplay, newInterval);
            }
        });
        vue.watch(() => props.effect, (newEffect) => {
...
exports.Canvas2DFallback = Canvas2DFallback;
exports.CarouselCore = CarouselCore;
exports.CircleEffect = CircleEffect;
exports.CustomEffect = CustomEffect;
exports.DissolveEffect = DissolveEffect;
exports.DistortionEffect = DistortionEffect;
exports.EffectManager = EffectManager;
exports.EventEmitter = EventEmitter;
exports.FadeEffect = FadeEffect;
exports.FlipEffect = FlipEffect;
exports.ImageLoader = ImageLoader;
exports.SlideEffect = SlideEffect;
exports.StateManager = StateManager;
exports.VERSION = VERSION;
exports.WaveEffect = WaveEffect;
exports.WebGLCarousel = WebGLCarousel;
exports.WebGLCarouselReact = WebGLCarouselReact;
exports.WebGLCarouselVue = WebGLCarouselVue;
exports.WebGLRenderer = WebGLRenderer;
exports.circleEffect = circleEffect;
exports.circleFromCenterEffect = circleFromCenterEffect;
exports.circleFromCornerEffect = circleFromCornerEffect;
exports.commonShaderFunctions = commonShaderFunctions;
exports.createCustomEffect = createCustomEffect;
exports.createCustomEffectFromFiles = createCustomEffectFromFiles;
exports.createEffectManager = createEffectManager;
exports.createFragmentShader = createFragmentShader;
exports.default = WebGLCarousel;
exports.dissolveEffect = dissolveEffect;
exports.distortionEffect = distortionEffect;
exports.extremeDistortionEffect = extremeDistortionEffect;
exports.fadeEffect = fadeEffect;
exports.flipHorizontalEffect = flipHorizontalEffect;
exports.flipVerticalEffect = flipVerticalEffect;
exports.gentleWaveEffect = gentleWaveEffect;
exports.getDefaultEffects = getDefaultEffects;
exports.intenseWaveEffect = intenseWaveEffect;
exports.pixelDissolveEffect = pixelDissolveEffect;
exports.registerDefaultEffects = registerDefaultEffects;
exports.slideDownEffect = slideDownEffect;
exports.slideLeftEffect = slideLeftEffect;
exports.slideRightEffect = slideRightEffect;
exports.slideUpEffect = slideUpEffect;
exports.smoothDissolveEffect = smoothDissolveEffect;
exports.subtleDistortionEffect = subtleDistortionEffect;
exports.waveEffect = waveEffect;
//# sourceMappingURL=webgl-carousel.cjs.js.map
